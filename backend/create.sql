create table tb_sales (id bigint identity not null, amount double precision not null, date date, deals int, visited int, seller_id bigint, primary key (id));
create table tb_sellers (id bigint identity not null, name varchar(255), primary key (id));
